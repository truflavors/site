...
import { products, getProductImage, PLACEHOLDER_IMAGE } from "@/data/products";
  ...
  if (!p) {
    return (
      <section className="container-max py-10">
        ...
        <Link href="/products" className="link mt-2 inline-block">
          Back to products →
        </Link>
      </section>
    );
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-gray-700 leading-relaxed">
            {p.description ||
              "Balanced spice, cleaner fats, and clear labels. Pair with your choice of protein and vegetables for a complete meal."}
          </p>
